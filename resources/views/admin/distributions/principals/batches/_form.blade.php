<form action="{{ route('admin.distributions.store') }}" method="POST">
    ...
    <div class="form-control w-full max-w-sm">
        ...
        <input type="text" name="name" required="required" minlength="3" placeholder="Type Distribution Name here" class="input input-bordered w-full max-w-sm" />
    </div>
    <div class="form-control w-full max-w-sm">
        <label class="label">
    ...
    <div class="alert alert-info shadow-lg mt-5">
        <div>
            ...
            <span class="font-bold">Notice! Distribution Password will be set to "abcd1234"</span>
        </div>
    </div>
